...
class Lecturer{
    ...
    getDetails(){return `Last Name: ${this.lastName}, First Name: ${this.firstName}, Track: ${this.track}, Department: ${this.department}, Experience: ${this.experience} years, ID: ${this.lecturerID}`;}
}
